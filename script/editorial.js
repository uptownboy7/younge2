$(document).ready(function () {
	...
	function fader(){ 
        if(i==4){
            ...
            i = 0;
        } else{$("#headerphotos>img").eq(i).fadeOut("slow");
        i++;
        }
    };        
    ...
    */
    ...
    $('#iframe1').contents().find('.imgBX>a').click(function () {
        alert("바보");

        var photogo2 = $(this).children("img").attr("src");
        console(photogo2);

        $("#bigphoto>div>a>img").attr("src", photogo2);
